...
const campaigns = {
  ...
  campaign1: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Campaign2.png",
    text: `
<tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b> Подключение займёт 30 секунд!</b>

<b>[name]</b>, пока Ваш кофе будет готов Вы успеете подключить прокси! <tg-emoji emoji-id="5307845791283425776">🟣</tg-emoji>

Нажмите на кнопку ниже, выберите подходящий тариф и прокси Ваш!!! <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
    `.trim(),
    buttons: [
      [
        {
  ...
  campaign2: {
    photo:
      "C:\\Users\\User\\Desktop\\DedBot\\ChatGPT Image May 27, 2026, 11_11_16 PM.png",
    text: `
...
Напишите нам, нажав на кнопку ниже <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
  ...
  campaign3: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Camp3.png",
    text: `

  <tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b> Вы на пол пути к быстрому и стабильному подключению!</b>

Купив наш прокси Вы получите:
<tg-emoji emoji-id="5188481279963715781">🚀</tg-emoji> Скоростные прокси для Telegram и WhatsApp
<tg-emoji emoji-id="5456140674028019486">⚡️</tg-emoji> Моментальную доставку сообщениий и медиа
...
Нажмите на кнопку ниже, чтобы выбрать тариф <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
  ...
  campaign4: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Camp4.png",
    text: `
<tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b>У Вас бонус на первый заказ!</b> <tg-emoji emoji-id="5452000149461024555">🎁</tg-emoji>

<b>[name]</b>, мы подготовили для Вас промокод, чтобы первое подключение было ещё выгоднее:

<tg-emoji emoji-id="5990219324709671254">#️⃣</tg-emoji> <b>FASTPROXY</b>
...
`.trim(),
  ...
  campaign5: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Camp5.png",
    text: `
<tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b> В Дед Коннект можно зарабатывать!</b>

[name], теперь Вы можете не только пользоваться быстрым прокси, но и получать бонусы с покупок Ваших друзей и знакомых.
...
Нажмите на кнопку ниже, чтобы получить ссылку <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
  ...
  // Кампания 6 — тариф скоро заканчивается

  // Когда отправлять:
  // Когда активный тариф пользователя скоро заканчивается.
  // Рекомендуемое время:
  // для тарифа на 24 часа — за 2 часа до окончания;
  // для длинных тарифов — за 24 часа до окончания.
  // Не отправлять, если:
  // Пользователь уже продлил тариф.

  campaign6: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Camp6.png",
    text: `
<tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b> Напоминание!</b>

<b>[name]</b>, срок Вашего прокси скоро подойдёт к концу.

Рекомендуем продлить доступ заранее. <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
    `.trim(),

    buttons: [
      [
        {
          text: "Продлить прокси",
          icon_custom_emoji_id: "5283139309740765379",
          callback_data: "renew_proxy",
        },
      ],
    ],
  },

  // Кампания 7 — тариф закончился

  // Когда отправлять:
  // После окончания тарифа, если пользователь не продлил доступ.

  campaign7: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Camp7.png",
    text: `
<tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b> Ваш тариф закончился</b>

<b>[name]</b>, надеемся, Вам понравился <b>Дед Коннект</b><tg-emoji emoji-id="5350702035819833989">🟣</tg-emoji>. 

Вы можете продолжить пользоваться прокси нажав на кнопку ниже. <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
    `.trim(),
  ...
  campaign8: {
    photo: "C:\\Users\\User\\Desktop\\DedBot\\Camp8.png",
    text: `
<tg-emoji emoji-id="5451927229506268442">🔔</tg-emoji><b> Лучший момент вернуться</b>

<b>[name]</b>, давно не пользовались Дед Коннект?

<tg-emoji emoji-id="5420315771991497307">🔥</tg-emoji> Если Вам снова нужен быстрый прокси для Telegram и WhatsApp, мы подготовили для Вас специальный подарок.

Используйте промокод ниже и получите скидку на 20%!

<tg-emoji emoji-id="5990219324709671254">#️⃣</tg-emoji> <b>BESTPROXY</b>


Дед коннект — это быстрый доступ, удобные тарифы и стабильное подключение по всей стране. <tg-emoji emoji-id="5197474438970363734">👇</tg-emoji>
    `.trim(),
